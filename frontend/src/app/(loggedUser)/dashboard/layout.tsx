  ...
  return (
    <section className="flex w-full h-full">
      <div className="w-80 bg-white h-full flex flex-col gap-5 justify-center shadow-md p-2">
        ...
        <NavBarItem route="/dashboard/perfil" text="Gerenciamento de perfil">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <NavBarItem route="/dashboard/transaction" text="Gerenciamento de transação">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <NavBarItem route="/dashboard/function" text="Gerenciamento de função">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
